...
{
  "meta": {
    "pageTitle": "Happy Birthday Lupita Nice",
    "ogTitle": "",
    "ogDescription": " ",
    "publicUrl": ""
  },
  "event": {
    ...
    "label": "Mi cumple",
    "age": "",
    "celebrantName": "Lupita Nice",
    "person1Name": "",
    "person2Name": "",
    "eventDate": "2026-08-22T16:00",
    "eventEnd": "2026-08-23T09:00",
    "calendarTitle": "Birthday party Lupita Nice",
    "timeZone": "America/Mexico_City",
    "eventLocation": "Quinta Regi",
    "rsvpCountryCode": "52",
    "rsvpPhone": "8141883004"
  },
  "theme": {
    "bgTop": "#ffe1ea",
    "bgMid": "#f7c5d3",
    ...
    "timelineTimeColor": "#8f3f4a",
    "timelineTitleColor": "#542d35",
    "timelineDescColor": "#76555b",
    "timelineFont": "Cormorant Garamond",
    "locationTitleColor": "#8f3f4a",
    "locationTimeColor": "#a44c58",
    "locationPlaceColor": "#542d35",
    "particleColor": "#d89aaa",
    "buttonBg": "#8f3154",
    "buttonText": "#ffffff",
    "fieldLabel": "#7e2d4d",
    "fieldText": "#3d2332",
    ...
    "backgroundImage": "media/fdppc.png",
  ...
  "audio": {
    "src": "media/don-omar---danza-kuduro-letralyrics-ft-lucenzo.mp3",
    "showControl": true
  },
  "story": {
    "title": "Mi historia",
    "paragraph1": "Hoy celebro la vida, los momentos que se han convertido en recuerdos y a cada persona que, con su cariño, ha formado parte de mi camino.",
    "paragraph2": "Cada etapa ha dejado algo especial en mí, y hoy quiero disfrutar este momento rodeada de quienes han hecho mi historia aún más bonita.",
    "showImage": true,
    "imageSize": 55
  },
  "family": {
    "parentsEyebrow": "En compañía de mis padres",
    "parentsNamesHtml": "Nombre de mamá<br>&amp;<br>Nombre de papá",
    "parentsGroups": [],
    "parentsInviteText": "Tenemos el honor de invitarles a celebrar mis XV años.",
    "godparentsEyebrow": "Mis padrinos",
    "godparentsNamesHtml": "Nombre de padrino<br>&amp;<br>Nombre de madrina",
    "godparentsItems": []
  },
  "ceremony": {
    "title": "Ceremonia",
    "time": "",
    "place": "Nombre del lugar de ceremonia",
  ...
  "reception": {
    ...
    "placeDetail": "Portal del Norte",
    "mediaMode": "icon",
    "iconSrc": "media/recepcion.png",
    "mapLink": "https://maps.app.goo.gl/vQSkm6aWG4K3NHHn6",
    "mapEmbed": "",
    "photoSrc": ""
  },
  "timeline": {
    "items": [
      {
        "time": "19:00 hrs",
        "title": "Inicio de la celebración ✨",
        "desc": "Disfrutemos juntos de una deliciosa cena."
      },
      {
        "time": "21:00 hrs",
        "title": "Brindis 🥂",
        "desc": "Palabras de agradecimiento y un momento para celebrar."
      },
      {
        "time": "21:30 hrs",
        "title": "Mañanitas y pastel 🎶🍰",
        "desc": "Cantemos juntos y compartamos el pastel."
      },
      {
        "time": "22:00 hrs",
        "title": "DJ & Karaoke 🎤🎶",
        "desc": "¡Que comience la música y la diversión!"
      },
      {
        "type": "day-separator",
        "title": "Domingo 23 de agosto",
        "time": "",
        "desc": ""
      },
      {
        "time": "08:00 hrs",
        "title": "Desayuno ☕🍳",
        "desc": "Un nuevo día para seguir compartiendo juntos."
      },
      {
        "time": "09:00 hrs",
        "title": "Fin del evento 🤍",
        "desc": "Cierre de nuestra celebración y despedida."
      }
    ]
  },
  "countdown": {
    "title": "Faltan pocos días",
    "intro": "Falta muy poco para celebrar la vida y crear juntos nuevos recuerdos inolvidables.",
    "caption": "",
    "captionColor": "#8e3154",
    "style": "classic"
  },
  ...
  "customSections": [
    {
      "id": "section-msxrrmz2-wzwsg",
      "enabled": true,
      "title": "Happy birthday",
      "text": "16:00 h — Llegada al evento\n16:30 h — Entrada a la alberca ",
      "images": [],
      "imageLayout": "stack"
    }
  ],
  ...
  "brand": {
    ...
    function buildConfirmationQrPayload(receipt) {
      ...
      if (attendees.length) payload.a = attendees;
    ...
    function renderRsvpReceipt(receipt) {
      ...
      const qrOptions = {
        ...
        margin: 16,
        qrOptions: { errorCorrectionLevel: "Q" },
        dotsOptions: { color: "#393238", type: "dots" },
        cornersSquareOptions: { color: "#292329", type: "extra-rounded" },
        cornersDotOptions: { color: "#a4774d", type: "dot" },
